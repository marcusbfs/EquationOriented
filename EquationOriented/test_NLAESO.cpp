...
//	Vector<std::shared_ptr<EqNode>>* EqnSystem;
...
//
//		EqnSystem = new Vector<std::shared_ptr<EqNode>>(numberEqns);
//		EqnSystem->operator()(0) = eq1;
//		EqnSystem->operator()(1) = eq2;
//
//		// Declare vars
...
//	}
//
//	Vector<double> GetAllVariables() {
//		Vector<double> AllVariables(2);
//		AllVariables(0) = x->value();
//		AllVariables(1) = y->value();
//		return AllVariables;
//	}
//
//	void SetAllVariables(Vector<double>& VarValues) {
//		x->v = VarValues(0);
//		y->v = VarValues(1);
//	}
//
//	void GetParameterList(Vector<std::shared_ptr<EqNode>>& TheListOfParameters) {
...
//	}
//
//	void GetAllResiduals(Vector<double>& AllResiduals) {
//		AllResiduals(0) = eq1->getValue();
//		AllResiduals(1) = eq2->getValue();
//	}
//
//	void GetAllJacobianValues(Matrix<double>& AllJacobianValues) {
...
//		unsigned int i, j;
//
//		Vector<std::shared_ptr<EqNode>> parametersList(numberVars);
//		GetParameterList(parametersList);
//
//		for (i = 0; i < numberEqns; i++) {
//			for (j = 0; j < numberVars; j++) {
//				AllJacobianValues(i,j) = EqnSystem->operator()(i)->getDerValue(parametersList(j));
//			}
//		}
//	}
//
...
//
//	// Resize vectors
//	Vector<double> AllResiduals(eso->GetNumEqns()), AllVariables(eso->GetNumEqns());
//	Matrix<double> AllJacobians(eso->GetNumEqns(), eso->GetNumVars());
//	Vector<std::shared_ptr<EqNode>> ParametersList(eso->GetNumVars());
//
